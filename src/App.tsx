    ...
    <div className="min-h-screen bg-background mobile-container">
      ...
      <section className="relative py-8 md:py-20 px-4 bg-gradient-hero overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <h1 className="font-display text-3xl sm:text-4xl md:text-6xl lg:text-8xl font-bold mb-6 bg-gradient-primary bg-clip-text text-transparent animate-scale-in leading-tight">
            Botora
          </h1>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-muted-foreground mb-6 md:mb-8 max-w-3xl mx-auto animate-fade-in delay-200 leading-relaxed px-4">
